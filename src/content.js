...
(function() {
	...
	btn.addEventListener( 'click', function( evt ) {
		...
		// Note: tbcajaService 要求入口参数字符串是 GBK 编码方式
		xhr.send( 'token=TAE-SDK&content=' + encodeURIComponent_gbk( data.js ) + '&component=tae_js_testbed' );
	});
...
// 以下代码用于对字符串实施 GBK 编码形式的 encodeURIComponent 功能
// 来自 https://code.google.com/p/meichua/
...
var encodeURI_gbk = function(str) {
    if(str != null) {
        var result = "";
...
var encodeURIComponent_gbk = function(str) {
    if(str != null) {
        var result = "";
        for(var i=0;i<str.length;i++) {
            var d = str.charCodeAt(i);
